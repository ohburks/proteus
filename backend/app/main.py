...
from app.routers import accounts, assessments, audit, auth, calibration, excerpts, review, roster, rubrics, settings

app = FastAPI(title="Proteus Professor-Calibrated Grading")
