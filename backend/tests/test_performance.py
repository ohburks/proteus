...
class FakeBatchClient:
    ...
    def complete(self, system_prompt: str, user_prompt: str, emit=None) -> str:
...
def test_batch_pass_grades_multiple_criteria_in_one_provider_call():
...
def test_batch_retry_preserves_valid_results_and_repairs_only_bad_ones():
    client = FakeBatchClient([
        {
            "results": [
